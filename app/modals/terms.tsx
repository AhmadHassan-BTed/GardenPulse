...
export default function TermsSheet() { const isDark = useColorScheme() === "dark";
  return (<View style={[styles.container, { backgroundColor: isDark ? "#1a1a1a" : "#F5F5F5" }]}><Text style={[styles.title, { color: isDark ? "#fff" : "#1c4a22" }]}>Terms of Service</Text><Text style={styles.placeholder}>GardenPulse terms and conditions</Text></View>);
}
