...
export default function AllBadgesSheet() { const isDark = useColorScheme() === "dark";
  return (<View style={[styles.container, { backgroundColor: isDark ? "#1a1a1a" : "#F5F5F5" }]}><Text style={[styles.title, { color: isDark ? "#fff" : "#1c4a22" }]}>All Badges</Text><Text style={styles.placeholder}>View all earned and available badges</Text></View>);
}
